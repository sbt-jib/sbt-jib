...
/**
 * @see
 *   [[https://github.com/sbt/sbt-native-packager/blob/main/src/main/scala/com/typesafe/sbt/packager/Stager.scala]]
 */
object Stager {
  ...
  def stageFiles(
    ...
    val cache  = cacheDirectory / ("jib-packager-mappings-" + config)
